...
import { FormInvitacionPage } from 'src/app/form-invitacion/form-invitacion.page';
...
@Component({
  ...
  templateUrl: './form-cocina.component.html',
  styleUrls: ['./form-cocina.component.scss'],
})
export class FormCocinaComponent implements OnInit {
